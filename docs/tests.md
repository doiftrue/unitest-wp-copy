...
- Generated instance-method traits: cover through their consuming runtime-adapted class under `tests/custom-mocks/...`; parser generation behavior belongs under `tests/parser/...`.
