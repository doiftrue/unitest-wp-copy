 ...
 *
 * prepare(), esc_like(), and their pure dependencies are copied from WordPress.
 * _real_escape() is runtime-adapted to use addslashes() without a DB connection.
 */
...
class WPDB_Runtime {
	...
	/** Fully copied from WordPress 7.0. */
