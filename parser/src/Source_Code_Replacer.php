...
class Source_Code_Replacer {
	...
	private static array $stub_wp_options = [
		...
		"get_option( 'html_type' )"       => "\$GLOBALS['stub_wp_options']->html_type",
		...
		"get_option( 'stylesheet' )"      => "\$GLOBALS['stub_wp_options']->stylesheet",
		"get_option( 'template' )"        => "\$GLOBALS['stub_wp_options']->template",
		...
		"get_option( 'blogdescription' )" => "\$GLOBALS['stub_wp_options']->blogdescription",
		"get_option( 'admin_email' )"     => "\$GLOBALS['stub_wp_options']->admin_email",
