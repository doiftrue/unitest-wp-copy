...
// define custom OR re-define options after init:
$GLOBALS['stub_wp_options']->my_option = 'test-value';
$GLOBALS['stub_wp_options']->template  = 'my-theme';
```

Full list of default options used by the runtime:
```php
// Used by get_option()
